...
@ stdcall -arch=x86_64 ExpInterlockedPopEntrySList(ptr ptr) RtlInterlockedPopEntrySList
...
@ fastcall -arch=i386 InterlockedCompareExchange(ptr long long)
@ fastcall -arch=i386 InterlockedDecrement(ptr)
@ fastcall -arch=i386 InterlockedExchange(ptr long)
@ fastcall -arch=i386 InterlockedExchangeAdd(ptr long)
@ fastcall -arch=i386 InterlockedIncrement(ptr)
...
@ stdcall -arch=i386 KeInitializeSpinLock(ptr) _KeInitializeSpinLock
...
@ stdcall -arch=i386 KeIsExecutingDpc()
...
@ stdcall -arch=i386 KeQuerySystemTime(ptr)
@ stdcall -arch=i386 KeQueryTickCount(ptr)
...
@ fastcall -arch=i386 KefAcquireSpinLockAtDpcLevel(ptr)
@ fastcall -arch=i386 KefReleaseSpinLockFromDpcLevel(ptr)
...
@ fastcall -arch=i386 KiAcquireSpinLock(ptr)
...
@ stdcall -arch=i386 KiDeliverApc(long ptr ptr)
@ stdcall -arch=i386 KiDispatchInterrupt()
@ extern -arch=i386 KiEnableTimerWatchdog
@ stdcall -arch=i386 KiIpiServiceRoutine(ptr ptr)
@ fastcall -arch=i386 KiReleaseSpinLock(ptr)
@ cdecl -arch=i386 KiUnexpectedInterrupt()
...
@ fastcall -arch=i386 RtlUlonglongByteSwap(long long)
...
@ cdecl -arch=i386 _except_handler2()
@ cdecl -arch=i386 _except_handler3()
@ cdecl -arch=i386 _global_unwind2()
@ cdecl _itoa()
@ cdecl _itow()
@ cdecl -arch=i386 _local_unwind2()
