...
INTRODUCTION
=============
This is Calc, a scientific calculator for Win32 and Win64 systems.
...
The user interface of Calc is really similar to Microsoft calculator, so you should be able to use this replacement very quickly.

COMPILATION
============
You need MinGW for compiling Calc.
...
========================
Calc uses HTMLHELP for opening the help file and generating the popups.
...
While Calc works fine with Microsoft's operating systems, there are some known issues with ReactOS:
...
Although Calc is pretty simple and I still think you should be able to understand the basic operations yourself, a good manual would be a nice presentation for new users.
