                     ...
                     IN OUT PFORMAT_CONTEXT Context)
{
    ...
    GreenteaFSUpdateProgress(Context, 1);
              ...
              IN OUT PFORMAT_CONTEXT Context)
{
    ...
    for (i = 1; i < BootSector->FATSectors32; i += Sectors)
    {
        ...
        GreenteaFSUpdateProgress(Context, Sectors);
    }
                        ...
                        IN OUT PFORMAT_CONTEXT Context)
{
    ...
    GreenteaFSUpdateProgress(Context, (ULONG)BootSector->SectorsPerCluster);
...
NTSTATUS
GreenteaFSPerformFormat(IN HANDLE FileHandle,
